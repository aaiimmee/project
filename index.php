...
<div class="pet_mian" id="top" style="margin-top:5px">
  ...
  <ul class="am-slides">
      <li>
            <img style="width:800px;height:385px;" src="img/11.jpg">
      ...
      <li>
            <img style="width:800px;height:385px;" src="img/12.jpg">
            <div class="pet_slider_font">
                <span class="pet_slider_emoji"> []~(￣▽￣)~*　</span>
                <span>麦积山石窟，国家AAAAA级旅游景区，一个神圣而美丽的地方！</span>
            </div>
            <div class="pet_slider_shadow"></div>
      </li>
      <li>
            <img style="width:800px;height:385px;" src="img/13.jpg">
            <div class="pet_slider_font">
...
<div class="pet_circle_nav">
    <ul class="pet_circle_nav_list">
        ...
        <img style="width:55px;height:55px;border:1px solid #ccc;border-radius:50%;"src="<?=$picture['user_picture'] ? $picture['user_picture']:'img/qq1.png';?>">
        </a><span>个人中心</span></li>
