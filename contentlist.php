                                ...
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    ?>
                                        <tr>
                                             ...
                                             <td class="hidden-phone" style="width:200px;"><?=$value['news_title'];?></td>
                                             <td class="hidden-phone" style="width:500px;"><?=$value['news_content_text'];?></td>
                                             <td class="hidden-phone"><img style="width:150px;height:80px;" src="<?=$value['news_picture'];?>" alt=""></td>
